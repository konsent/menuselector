document.addEventListener('DOMContentLoaded', () => {
    ...
    const ingredientCategoryMap = {
        ...
        // 해산물
        '황태': '해산물','고등어': '해산물', '오징어': '해산물', '새우': '해산물', '해산물': '해산물', '멸치': '해산물', '북어': '해산물', '꽁치': '해산물', '낙지': '해산물', '명란': '해산물', '골뱅이': '해산물', '꽃게': '해산물', '참치': '해산물', '진미채': '해산물',
        // 채소
        ...
        // 가공/유제품/계란
        '파마산 치즈': '가공/유제품', '계란': '가공/유제품', '유부': '가공/유제품', '소세지': '가공/유제품', '스팸': '가공/유제품', '어묵': '가공/유제품', '버터': '가공/유제품', '생크림': '가공/유제품', '우유': '가공/유제품', '순두부': '가공/유제품', '만두': '가공/유제품', '메추리알': '가공/유제품', '오뎅': '가공/유제품', '체다치즈': '가공/유제품', '소시지': '가공/유제품', '파슬리': '가공/유제품',
        // 곡물/면/가루
        '생강 가루': '곡물/면/가루', '밀가루': '곡물/면/가루', '부침가루': '곡물/면/가루', '당면': '곡물/면/가루', '스파게티면': '곡물/면/가루', '떡': '곡물/면/가루', '국수': '곡물/면/가루', '밥': '곡물/면/가루', '빵가루': '곡물/면/가루', '소면': '곡물/면/가루', '쌀': '곡물/면/가루', '찹쌀': '곡물/면/가루',
        // 소스/기타
        '멸치액젓': '소스/기타', '새우젓': '소스/기타', '스파게티 소스': '소스/기타', '토마토 소스': '소스/기타', '오꼬노미 소스': '소스/기타', '마요네즈': '소스/기타', '토마토소스': '소스/기타', '올리브유': '소스/기타', '카레가루': '소스/기타', '두반장': '소스/기타', '김': '소스/기타', '다시다': '소스/기타', '사골': '소스/기타', '간장': '소스/기타', '고운 고춧가루': '소스/기타', '고추장': '소스/기타', '고춧가루': '소스/기타', '국간장': '소스/기타', '굴 소스': '소스/기타', '굴소스': '소스/기타', '굵은소금': '소스/기타', '깨소금': '소스/기타', '돈까스 소스': '소스/기타', '된장': '소스/기타', '들기름': '소스/기타', '맛술': '소스/기타', '매실액': '소스/기타', '매실청': '소스/기타', '물엿': '소스/기타', '설탕': '소스/기타', '소금': '소스/기타', '소주': '소스/기타', '식용유': '소스/기타', '식초': '소스/기타', '액젓': '소스/기타', '양조간장': '소스/기타', '올리고당': '소스/기타', '월계수': '소스/기타', '인스턴트 커피': '소스/기타', '진간장': '소스/기타', '집된장': '소스/기타', '참기름': '소스/기타', '청주': '소스/기타', '캐러멜 소스': '소스/기타', '케첩': '소스/기타', '통깨': '소스/기타', '통후추': '소스/기타', '후추': '소스/기타', '다진마늘': '소스/기타'
    };
